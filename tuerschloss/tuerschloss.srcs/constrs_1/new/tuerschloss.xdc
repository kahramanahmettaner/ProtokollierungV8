set_property -dict {PACKAGE_PIN K18 IOSTANDARD LVCMOS33} [get_ports {ButtonsIn[0]}] # Reset
set_property -dict {PACKAGE_PIN P16 IOSTANDARD LVCMOS33} [get_ports {ButtonsIn[1]}]
set_property -dict {PACKAGE_PIN K19 IOSTANDARD LVCMOS33} [get_ports {ButtonsIn[2]}]
set_property -dict {PACKAGE_PIN Y16 IOSTANDARD LVCMOS33} [get_ports {ButtonsIn[3]}]
